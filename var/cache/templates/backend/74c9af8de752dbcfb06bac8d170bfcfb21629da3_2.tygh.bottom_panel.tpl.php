<?php
/* Smarty version 4.1.1, created on 2023-05-28 18:27:44
  from 'D:\OSPanel\domains\profi.uz\design\backend\templates\components\bottom_panel\bottom_panel.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_647372f05291d5_14454213',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '74c9af8de752dbcfb06bac8d170bfcfb21629da3' => 
    array (
      0 => 'D:\\OSPanel\\domains\\profi.uz\\design\\backend\\templates\\components\\bottom_panel\\bottom_panel.tpl',
      1 => 1679461514,
      2 => 'tygh',
    ),
  ),
...
function content_647372f05291d5_14454213 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'D:\\OSPanel\\domains\\profi.uz\\app\\functions\\smarty_plugins\\block.hook.php','function'=>'smarty_block_hook',),1=>array('file'=>'D:\\OSPanel\\domains\\profi.uz\\app\\functions\\smarty_plugins\\modifier.enum.php','function'=>'smarty_modifier_enum',),2=>array('file'=>'D:\\OSPanel\\domains\\profi.uz\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.replace.php','function'=>'smarty_modifier_replace',),3=>array('file'=>'D:\\OSPanel\\domains\\profi.uz\\app\\functions\\smarty_plugins\\function.script.php','function'=>'smarty_function_script',),));
...
echo htmlspecialchars(fn_url("bottom_panel.redirect?url=".((string)(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url'])))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&to_area=C".$_prefixVariable13,$_smarty_tpl->tpl_vars['redirect_area']->value), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars(fn_url("customization.disable_mode?type=live_editor&return_url=".$_prefixVariable14), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "theme") {?>
                            href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable15=ob_get_clean();
echo htmlspecialchars(fn_url("customization.disable_mode?type=theme_editor&return_url=".$_prefixVariable15), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "build") {?>
                            href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable16=ob_get_clean();
echo htmlspecialchars(fn_url("customization.disable_mode?type=block_manager&return_url=".$_prefixVariable16), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } else { ?>
...
echo htmlspecialchars(fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_prefixVariable17), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars(fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_prefixVariable18), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
...
echo htmlspecialchars(fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_prefixVariable19), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
                            id="settings_block_manager"
