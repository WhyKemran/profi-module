<?php
/* Smarty version 4.1.1, created on 2023-05-28 18:28:11
  from 'D:\OSPanel\domains\profi.uz\design\backend\templates\common\select_object.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6473730b75c687_47249286',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a05c13e46e426ba653b3421f91bb09aaed7c993a' => 
    array (
      0 => 'D:\\OSPanel\\domains\\profi.uz\\design\\backend\\templates\\common\\select_object.tpl',
      1 => 1679461514,
      2 => 'tygh',
    ),
  ),
...
function content_6473730b75c687_47249286 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'D:\\OSPanel\\domains\\profi.uz\\app\\functions\\smarty_plugins\\modifier.sizeof.php','function'=>'smarty_modifier_sizeof',),1=>array('file'=>'D:\\OSPanel\\domains\\profi.uz\\app\\functions\\smarty_plugins\\function.include_ext.php','function'=>'smarty_function_include_ext',),));
...
"<?php }?>>
    <a class="btn btn-text dropdown-toggle <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['button_class']->value, ENT_QUOTES, 'UTF-8');?>
...
if ($_smarty_tpl->tpl_vars['items']->value[$_smarty_tpl->tpl_vars['selected_id']->value]['symbol']) {?>&nbsp;(<?php echo $_smarty_tpl->tpl_vars['items']->value[$_smarty_tpl->tpl_vars['selected_id']->value]['symbol'];?>
        ...
        <?php }?>
        <ul class="dropdown-menu cm-select-list <?php if ($_smarty_tpl->tpl_vars['display_icons']->value) {?>popup-icons<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_menu_class']->value, ENT_QUOTES, 'UTF-8');?>
">
            <?php
...
?>
                <li class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_menu_item_class']->value, ENT_QUOTES, 'UTF-8');?>
">
...
"
                       class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_menu_item_link_class']->value, ENT_QUOTES, 'UTF-8');?>
"
...
" <?php if ($_smarty_tpl->tpl_vars['select_container_id']->value) {?>id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['select_container_id']->value, ENT_QUOTES, 'UTF-8');?>
"<?php }?>>
        <a class="<?php if ($_smarty_tpl->tpl_vars['is_submenu']->value) {?>dropdown-submenu__link<?php } else { ?>dropdown-toggle<?php }?> cm-combination <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['button_class']->value, ENT_QUOTES, 'UTF-8');?>
"
           data-toggle="dropdown"
           id="sw_select_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_id']->value, ENT_QUOTES, 'UTF-8');?>
_wrap_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'UTF-8');?>
"
        ...
        <ul class="dropdown-menu cm-select-list pull-right <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_menu_class']->value, ENT_QUOTES, 'UTF-8');?>
">
            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['items']->value, 'item', false, 'id');
$_smarty_tpl->tpl_vars['item']->do_else = true;
...
?>
                ...
                <li class="<?php if ($_smarty_tpl->tpl_vars['id']->value == $_smarty_tpl->tpl_vars['selected_id']->value) {?>active<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_menu_item_class']->value, ENT_QUOTES, 'UTF-8');?>
">
                    <a name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="dropdown-toggle btn-text btn <?php if ($_smarty_tpl->tpl_vars['text_wrap']->value) {?>dropdown-toggle--text-wrap<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['button_class']->value, ENT_QUOTES, 'UTF-8');?>
" data-toggle="dropdown">
    <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['selected_name']->value, ENT_QUOTES, 'UTF-8');?>

        <span class="caret"></span>
    </a>
    <ul class="dropdown-menu cm-select <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_menu_class']->value, ENT_QUOTES, 'UTF-8');?>
">
        <?php
...
?>
            <li class="<?php if ($_smarty_tpl->tpl_vars['selected_key']->value == $_smarty_tpl->tpl_vars['key']->value) {?>disabled<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_menu_item_class']->value, ENT_QUOTES, 'UTF-8');?>
">
                <a class="<?php if ($_smarty_tpl->tpl_vars['selected_key']->value == $_smarty_tpl->tpl_vars['key']->value) {?>active<?php }?> cm-select-option <?php if ($_smarty_tpl->tpl_vars['text_wrap']->value) {?>dropdown--text-wrap<?php }?> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['dropdown_menu_item_link_class']->value, ENT_QUOTES, 'UTF-8');?>
"
...
" 
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['button_class']->value, ENT_QUOTES, 'UTF-8');?>
"
