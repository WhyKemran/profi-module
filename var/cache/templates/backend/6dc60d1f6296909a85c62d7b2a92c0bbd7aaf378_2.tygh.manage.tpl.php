...
/* Smarty version 4.1.1, created on 2023-05-28 18:28:13
  from 'D:\OSPanel\domains\profi.uz\design\backend\templates\addons\help_center\views\help_center\manage.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6473730da9b011_03493786',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6dc60d1f6296909a85c62d7b2a92c0bbd7aaf378' => 
    array (
      0 => 'D:\\OSPanel\\domains\\profi.uz\\design\\backend\\templates\\addons\\help_center\\views\\help_center\\manage.tpl',
      1 => 1679461514,
      2 => 'tygh',
    ),
  ),
...
function content_6473730da9b011_03493786 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
    ...
    <section data-ca-help-center="main"
        data-ca-help-center-server-url="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['help_center_server_url']->value, ENT_QUOTES, 'UTF-8');?>
"
        data-ca-help-center-request="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['help_center_request']->value, ENT_QUOTES, 'UTF-8');?>
"
        data-ca-help-center-default-dispatch="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_dispatch']->value, ENT_QUOTES, 'UTF-8');?>
"
        data-ca-help-center-active-dispatch="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_dispatch']->value, ENT_QUOTES, 'UTF-8');?>
"
        data-ca-help-center-is-inited="0"
        data-ca-help-center-relevant-chapter="info"
        data-ca-help-center-no-data-relevant-text="<?php echo htmlspecialchars(htmlspecialchars((string)$_smarty_tpl->__("help_center.no_data_relevant"), ENT_QUOTES, 'UTF-8', true), ENT_QUOTES, 'UTF-8');?>
"
        data-ca-help-center-no-data-text="<?php echo htmlspecialchars(htmlspecialchars((string)$_smarty_tpl->__("help_center.no_data"), ENT_QUOTES, 'UTF-8', true), ENT_QUOTES, 'UTF-8');?>
"
        data-ca-help-center-product-release-info="<?php echo htmlspecialchars(preg_replace('!\s+!u', ' ',strip_tags($_smarty_tpl->tpl_vars['product_release_info']->value)), ENT_QUOTES, 'UTF-8');?>
"
        data-ca-help-center-timestamp-last-view="<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['help_center_timestamp_last_view']->value ?? null)===null||$tmp==='' ? 0 ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
"
        data-ca-help-center-customer-last-update="<?php echo htmlspecialchars((($tmp = $_smarty_tpl->tpl_vars['help_center_customer_care_data_last_update']->value ?? null)===null||$tmp==='' ? 0 ?? null : $tmp), ENT_QUOTES, 'UTF-8');?>
"
        <?php if ($_smarty_tpl->tpl_vars['in_popup']->value) {?>
            data-ca-help-center-suffix="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'UTF-8');?>
"
            data-ca-help-center-in-popup="1"
        <?php }?>
        class="help-center <?php if ($_smarty_tpl->tpl_vars['in_popup']->value) {?>help-center--popup<?php }?>"
        id="manage_help_center_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'UTF-8');?>
"
    >
        <form action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'UTF-8');?>
" method="post" name="manage_help_center_form" class="help-center__form" id="manage_help_center_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'UTF-8');?>
">
