<?php
/* Smarty version 4.1.1, created on 2023-05-28 18:28:24
  from 'D:\OSPanel\domains\profi.uz\design\backend\templates\addons\geo_maps\components\scripts.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_64737318b48b46_79464955',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e5259f000f3a4421e8240f5e028d836705c06b88' => 
    array (
      0 => 'D:\\OSPanel\\domains\\profi.uz\\design\\backend\\templates\\addons\\geo_maps\\components\\scripts.tpl',
      1 => 1679461514,
      2 => 'tygh',
    ),
  ),
...
function content_64737318b48b46_79464955 (Smarty_Internal_Template $_smarty_tpl) {
...
>
    (function (_, $) {
        _.geo_maps = {
            provider: '<?php echo htmlspecialchars(strtr((string)$_smarty_tpl->tpl_vars['settings']->value['geo_maps']['general']['provider'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" )), ENT_QUOTES, 'UTF-8');?>
',
            api_key: '<?php echo htmlspecialchars(strtr((string)$_smarty_tpl->tpl_vars['api_key']->value, array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" )), ENT_QUOTES, 'UTF-8');?>
',
