...
/* Smarty version 4.1.1, created on 2023-05-28 18:28:48
  from 'D:\OSPanel\domains\profi.uz\design\backend\templates\views\index\components\analytics_section\analytics_card\resource_list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_64737330327223_05534605',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7df7cfa4e054cf58cf65841ea85db1fc303d0e53' => 
    array (
      0 => 'D:\\OSPanel\\domains\\profi.uz\\design\\backend\\templates\\views\\index\\components\\analytics_section\\analytics_card\\resource_list.tpl',
      1 => 1679461514,
      2 => 'tygh',
    ),
  ),
...
function content_64737330327223_05534605 (Smarty_Internal_Template $_smarty_tpl) {
...
?><div class="analytics-card-resource-list__item <?php echo htmlspecialchars('', ENT_QUOTES, 'UTF-8');
...
?></div><?php }?><div class="analytics-card-resource-list__item-content"><?php if ($_smarty_tpl->tpl_vars['item']->value['name'] || $_smarty_tpl->tpl_vars['item']->value['href'] || $_smarty_tpl->tpl_vars['item']->value['value'] || $_smarty_tpl->tpl_vars['item']->value['value_href']) {?><div class="analytics-card-resource-list__primary"><div class="analytics-card-resource-list__name"><?php if ($_smarty_tpl->tpl_vars['item']->value['href']) {?><a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['item']->value['href']), ENT_QUOTES, 'UTF-8');?>
...
if ($_smarty_tpl->tpl_vars['item']->value['label_text']) {?><div class="analytics-card-resource-list__label label btn-info label--text-wrap <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['label_class'], ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['label_text'], ENT_QUOTES, 'UTF-8');?>
</div><?php }?></div><?php if ($_smarty_tpl->tpl_vars['item']->value['value_href'] && (isset($_smarty_tpl->tpl_vars['item']->value['value']))) {?><a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['item']->value['value_href']), ENT_QUOTES, 'UTF-8');?>
...
if ($_smarty_tpl->tpl_vars['item']->value['description'] || $_smarty_tpl->tpl_vars['item']->value['description_href'] || $_smarty_tpl->tpl_vars['item']->value['small_text']) {?><div class="analytics-card-resource-list__secondary"><?php if ($_smarty_tpl->tpl_vars['item']->value['description_href']) {?><a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['item']->value['description_href']), ENT_QUOTES, 'UTF-8');?>
