...
/* Smarty version 4.1.1, created on 2023-05-28 18:28:43
  from 'D:\OSPanel\domains\profi.uz\design\backend\templates\views\index\components\custom_blocks_section\custom_blocks_section.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6473732b7b2140_60940261',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '15f2d6ea810b3ab61c825a0e543fd7c51a3d54f0' => 
    array (
      0 => 'D:\\OSPanel\\domains\\profi.uz\\design\\backend\\templates\\views\\index\\components\\custom_blocks_section\\custom_blocks_section.tpl',
      1 => 1679461514,
      2 => 'tygh',
    ),
  ),
...
function content_6473732b7b2140_60940261 (Smarty_Internal_Template $_smarty_tpl) {
...
ob_start();
echo htmlspecialchars(smarty_modifier_enum("CustomBlockSections::ONBOARDING"), ENT_QUOTES, 'UTF-8');
$_prefixVariable1 = ob_get_clean();
$_smarty_tpl->_assignInScope('section', (($tmp = $_smarty_tpl->tpl_vars['section']->value ?? null)===null||$tmp==='' ? $_prefixVariable1 ?? null : $tmp));
ob_start();
echo htmlspecialchars(smarty_modifier_enum("CustomBlockTypes::BLOCK"), ENT_QUOTES, 'UTF-8');
...
}?><section class="custom-blocks-section <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['custom_blocks_section_class']->value, ENT_QUOTES, 'UTF-8');?>
" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['custom_blocks_section']->value['id'], ENT_QUOTES, 'UTF-8');?>
"><?php if ($_smarty_tpl->tpl_vars['show_custom_blocks_section']->value && ($_smarty_tpl->tpl_vars['custom_blocks_section']->value['content'] || $_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['block_manager'])) {?><div class="custom-blocks-section__inner" <?php echo htmlspecialchars('', ENT_QUOTES, 'UTF-8');
if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['block_manager']) {?>data-ca-block-manager-grid-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['custom_blocks_section']->value['id'], ENT_QUOTES, 'UTF-8');?>
"<?php }?>><?php if ($_smarty_tpl->tpl_vars['custom_blocks_section']->value['title']) {?><h2 class="custom-blocks-section__title"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['custom_blocks_section']->value['title'], ENT_QUOTES, 'UTF-8');?>
...
?></div><?php }?></div><?php }?><!--<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['custom_blocks_section']->value['id'], ENT_QUOTES, 'UTF-8');?>
--></section><?php }
}
