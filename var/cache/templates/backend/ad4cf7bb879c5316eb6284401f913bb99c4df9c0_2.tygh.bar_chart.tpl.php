<?php
/* Smarty version 4.1.1, created on 2023-05-28 18:28:47
  from 'D:\OSPanel\domains\profi.uz\design\backend\templates\views\index\components\analytics_section\analytics_card\bar_chart.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6473732fbd1ab7_86768886',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ad4cf7bb879c5316eb6284401f913bb99c4df9c0' => 
    array (
      0 => 'D:\\OSPanel\\domains\\profi.uz\\design\\backend\\templates\\views\\index\\components\\analytics_section\\analytics_card\\bar_chart.tpl',
      1 => 1679461514,
      2 => 'tygh',
    ),
  ),
...
function content_6473732fbd1ab7_86768886 (Smarty_Internal_Template $_smarty_tpl) {
\Tygh\Languages\Helper::preloadLangVars(array('dashboard.analytics_card.unlimited'));
if ($_smarty_tpl->tpl_vars['bar_chart']->value && $_smarty_tpl->tpl_vars['bar_chart']->value['content']) {?><div class="analytics-card-bar-chart" data-ca-analytics-card="barChart" data-ca-analytics-card-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['analytics_card']->value['id'], ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['bar_chart']->value['id'], ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->_assignInScope('href_attr', $_smarty_tpl->tpl_vars['item']->value['href'] ? "href=".((string)(fn_url($_smarty_tpl->tpl_vars['item']->value['href']))) : '');?><div class="analytics-card-bar-chart__item" data-ca-analytics-card-bar-chart-item-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['analytics_card']->value['id'], ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['bar_chart']->value['id'], ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['id'], ENT_QUOTES, 'UTF-8');?>
"><div class="analytics-card-bar-chart__item-info"><?php if ($_smarty_tpl->tpl_vars['item']->value['name']) {?><<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_tag']->value, ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_attr']->value, ENT_QUOTES, 'UTF-8');?>
 class="analytics-card-bar-chart__item-name"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
</<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_tag']->value, ENT_QUOTES, 'UTF-8');?>
><?php }?><div class="analytics-card-bar-chart__item-values"><<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_tag']->value, ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_attr']->value, ENT_QUOTES, 'UTF-8');?>
...
</span></div></div><<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_tag']->value, ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_attr']->value, ENT_QUOTES, 'UTF-8');?>
...
if ($_smarty_tpl->tpl_vars['item']->value['total'] && $_smarty_tpl->tpl_vars['item']->value['value'] > $_smarty_tpl->tpl_vars['item']->value['total']) {?> analytics-card-bar-chart__item-bar--danger<?php }?>"<?php if ($_smarty_tpl->tpl_vars['ratio']->value > 0) {?> style="width: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ratio']->value, ENT_QUOTES, 'UTF-8');?>
%;"<?php }?>></div></div></<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['href_tag']->value, ENT_QUOTES, 'UTF-8');?>
></div><?php
}
