                        ...
                        {if $department}
                            ...
                            <div class="ty-grid-list__item ty-quick-view-button__wrapper ">
                                ...
                                <div class="ty-grid-list__item-name"><bdi>            
                                    <a href="{"departments.department?department_id={$department.department_id}"|fn_url}" class="product-title" title="{$department.department}"><strong>Отдел:</strong> {$department.department}</a>    
                                </bdi></div>
                                <div class="ty-grid-list__item-name"><bdi>
                                    <label class="product-title"><strong>Руководитель:</strong> {$department.user_id|fn_get_user_name}</label>
                                </bdi></div>
